...
Before editing or deleting files, running code, or executing commands, show the plan and ask for confirmation; prefer non-destructive, reversible changes (e.g., propose a diff) and defaults that fail safe.
